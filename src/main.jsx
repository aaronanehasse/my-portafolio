...
// A fresh visit to a deep link (someone opening /#projects) still goes there.
// Contact used to be a section on the home page; old /#contact links go to its page now.
if (location.pathname === '/' && location.hash === '#contact') location.replace('/contact')
